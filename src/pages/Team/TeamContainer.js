...
import { fetchTeams, getHistoricValues, getNotes, createNote } from './TeamActions';
...
export default connect(mapStateToProps, { fetchTeams, getHistoricValues, getNotes, createNote })(Team);
